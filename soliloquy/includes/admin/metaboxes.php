	                ...
	                <tbody>
	                    ...
	                    <tr id="soliloquy-config-caption-delay-box">
	                        ...
	                        <td>
	                            ...
	                            <p class="description"><?php esc_html_e( 'The amount of time to delay displaying the caption after the slide has appeared <strong>(in milliseconds)</strong>. Set to zero for caption to display immediately.', 'soliloquy' ); ?></p>
	                        </td>
	                    </tr>
	                    ...
	                    <tr id="soliloquy-config-delay-box">
	                        ...
	                        <td>
	                            ...
	                            <p class="description"><?php esc_html_e( 'If autostarting, this sets a delay before the slider should begin transitioning <strong>(in milliseconds)</strong>.', 'soliloquy' ); ?></p>
	                        </td>
	                    </tr>
