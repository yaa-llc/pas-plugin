...
if( function_exists('acf_add_local_field_group') ):
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            array(
                ...
                'sub_fields' => array(
                    array(
                        'key' => 'field_5a14447d381d8',
                        'label' => 'Stone Collection Link Text',
                        'name' => 'stone_collection_link_text',
                        'type' => 'text',
                        'instructions' => 'Please write what you would like the link text to be. For example "Natural Stone"',
                        'required' => 0,
                        'conditional_logic' => 0,
                        'wrapper' => array(
                            'width' => '',
            ...
            array(
                ...
                'sub_fields' => array(
                    array(
                        'key' => 'field_5a14494e54109',
                        'label' => 'Inspiration Link Text',
                        'name' => 'inspiration_link_text',
                        'type' => 'text',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => 0,
                    ...
                    array(
                        ...
                        'label' => 'Inspiration Gallery Link',
                        'name' => 'footer_inspiration_gallery_link',
                        'type' => 'link',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => 0,
                    ...
                    array(
                        'key' => 'field_5a144bbf06a54',
                        'label' => 'Dealer Link Text',
                        'name' => 'dealer_link_text',
                        'type' => 'text',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => 0,
                    ...
                    array(
                        'key' => 'field_5a144bcb06a55',
                        'label' => 'Dealer Page Link',
                        'name' => 'dealer_page_link',
                        'type' => 'page_link',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => 0,
                    ...
                    array(
                        'key' => 'field_5a144c0006a56',
                        'label' => 'Brochure Download Text',
                        'name' => 'brochure_download_text',
                        'type' => 'text',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => 0,
                    ...
                    array(
                        'key' => 'field_5a144c0e06a57',
                        'label' => 'Brochure File',
                        'name' => 'footer_brochure_file',
                        'type' => 'file',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => 0,
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            array(
                'key' => 'field_5a135c2d8f934',
                'label' => 'Custom Home Page Logo',
                'name' => 'custom_home_page_logo',
                'type' => 'image',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
                ...
                'layouts' => array(
                    ...
                    '5a04862762cff' => array(
                        ...
                        'sub_fields' => array(
                            ...
                            array(
                                'key' => 'field_5a16d89063dce',
                                'label' => 'Be Inspired CTA Link Text',
                                'name' => 'be_inspired_cta_link_text',
                                'type' => 'text',
                                'instructions' => 'Please write what you want the link to say',
                                'required' => 0,
                                'conditional_logic' => 0,
                                'wrapper' => array(
                                    'width' => '',
                    ...
                    '5a08610d4af50' => array(
                        ...
                        'sub_fields' => array(
                            ...
                            array(
                                'key' => 'field_5a16c5183c971',
                                'label' => 'Link Text',
                                'name' => 'stone_collection_link_text',
                                'type' => 'text',
                                'instructions' => 'Please write the words you want to see in the link ie) view collection',
                                'required' => 1,
                                'conditional_logic' => 0,
                                'wrapper' => array(
                                    'width' => '',
                            ...
                            array(
                                'key' => 'field_5a15b5ac54c3d',
                                'label' => 'Stone Collection Row Background Image',
                                'name' => 'stone_collection_row_background_image',
                                'type' => 'image',
                                'instructions' => '',
                                'required' => 0,
                                'conditional_logic' => 0,
    ...
    acf_add_local_field_group(array(
        'key' => 'group_5a143bb612674',
        'title' => 'Social Media',
        'fields' => array(
            array(
                'key' => 'field_5a143bc9abd64',
