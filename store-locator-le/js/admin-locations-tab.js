...
var SLP_Location_Editor = function () {
    ...
    var add_modal = jQuery( '.add_location_modal' );

    /**
     * Initialize
     */
    this.initialize = function( ) {
        jQuery( 'a[data-action="edit"]' ).click( function() { SLP_Location_Manager.Editor.load_and_show_form( jQuery( this ) ); });
    ...
    this.load_and_show_form = function( action_button ) {
        ...
        add_modal.find( '#modalTitle' ).click( this.close );
