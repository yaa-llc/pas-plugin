...
HTML;
        ...
        public function create_settings_section_Add() {
	        $add_locations_form = SLP_Admin_Locations_Add::get_instance();
	        $add_locations_form->build_interface();
        }
        ...
        private function create_string_manage_locations_table() {
            ...
            while (
                ...
                $html .=
                    ...
                    $this->create_action_buttons_html() .
                    "</div></td>";
        ...
        private function createstring_SearchBlock() {
            $currentSearch = ! empty( $_REQUEST['searchfor'] ) ? $_REQUEST['searchfor'] : '' ;
        ...
        function set_location_query() {
            ...
            //
            if ( ! empty( $_POST['searchfor'] ) && ( $this->current_action === '' ) ) {
                $this->start = 0;
        ...
        private function set_search_filter() {
            ...
            // Fix the new fucked up WP mangled queries because you know the core DB engine needs to be slower...
            //
            $wp83_screwed_this_up_query = esc_sql( $this->slplus->db->esc_like( $clean_search_for ) );
            global $wp_version;
            if ( version_compare( $wp_version, '4.8.3', '>=' ) ) {
                global $wpdb;
                $wp83_screwed_this_up_query = $wpdb->remove_placeholder_escape( $wp83_screwed_this_up_query );
            }
