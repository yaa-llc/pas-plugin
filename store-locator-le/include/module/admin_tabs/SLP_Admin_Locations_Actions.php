...
if ( ! class_exists( 'SLP_Admin_Locations_Actions' ) ) {
    ...
    class SLP_Admin_Locations_Actions extends SLPlus_BaseClass_Object {
        ...
        private function save_edited_location() {
	        ...
	        $priorIsGeocoded = is_numeric( $this->slplus->currentLocation->latitude ) && is_numeric( $this->slplus->currentLocation->longitude );
	        $priorAddress    = $this->slplus->currentLocation->address . ' ' . $this->slplus->currentLocation->address2 . ', ' . $this->slplus->currentLocation->city . ', ' . $this->slplus->currentLocation->state . ' ' . $this->slplus->currentLocation->zip;
	        ...
	        //
	        if ( ! $given_lat && ! $given_lng ) {
		        $newAddress = $this->slplus->currentLocation->address . ' ' . $this->slplus->currentLocation->address2 . ', ' . $this->slplus->currentLocation->city . ', ' . $this->slplus->currentLocation->state . ' ' . $this->slplus->currentLocation->zip;
	        ...
	        //
	        $this->slplus->currentLocation->dataChanged = $this->slplus->currentLocation->dataChanged || $this->set_extended_data_booleans();
	...
	if ( is_a( $slplus, 'SLPlus' ) ) {
		$slplus->add_object( new SLP_Admin_Locations_Actions( ) );
	}
}