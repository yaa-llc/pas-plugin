...
if (!class_exists('SLP_BaseClass_Addon')) {
     ...
     * @property        SLP_Add_Ons_Meta     $meta
    ...
    class SLP_BaseClass_Addon extends SLP_Object_WithOptions {
	    ...
	    private function create_object_meta() {
		    if ( ! isset( $this->meta ) ) {
			    require_once( SLPLUS_PLUGINDIR . 'include/module/add_ons/SLP_Add_Ons_Meta.php' );
			    $this->meta = new SLP_Add_Ons_Meta( array( 'addon' => $this ) );
		    }
	    }
	    ...
	    public function createobject_UserInterface() {
		    if ( ! isset( $this->userinterface ) ) {
			    ...
			    if ( class_exists( $this->userinterface_class_name ) ) {
				    $this->userinterface = new $this->userinterface_class_name( array( 'addon' => $this ));
			    } else {
